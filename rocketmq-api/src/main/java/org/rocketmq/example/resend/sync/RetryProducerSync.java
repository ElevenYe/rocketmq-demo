package org.rocketmq.example.resend.sync;
...
/**
 * 同步发送异常重试设置
 * 通过 setRetryTimesWhenSendFailed 设置失败重试次数，如果不设置系统将默认重试 2 次
 * 当生产者出现 RemotingException 、 MQClientException 和 MQBrokerException 时，Producer 将触发重试机制
 */
public class RetryProducerSync {

    private static final String NAMESRV_ADDRS = new ConfigUtil().getClusterIps();
    private static final String PRODUCER_GROUP = "RetryProducerSyncTestGroup";
    private static final String TOPIC = "Topic-RetryProducerSyncMessage";
