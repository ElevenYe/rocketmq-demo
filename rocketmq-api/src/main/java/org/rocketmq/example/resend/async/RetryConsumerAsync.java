 ...
 *
 */
public class RetryConsumerAsync {

    private static final String NAMESRV_ADDRS = new ConfigUtil().getClusterIps();
    private static final String PRODUCER_GROUP = "RetryConsumerAsyncTestGroup";
    private static final String TOPIC = "Topic-RetryConsumerAsyncMessage";
